...
def get_psych_state(score):
    if 0 <= score <= 15:
        return "Excellent replay usage"
    elif 16 <= score <= 30:
        return "Good reinforcement — continue"
    elif 31 <= score <= 45:
        return "Moderate understanding — re-watch key parts"
    elif 46 <= score <= 60:
        return "Low reinforcement — take better notes"
    else:
        return "Very low reinforcement — improve lecture review habits"
